...
static void appln_client_connected(
	const TcpServerController *tcp_server, const TcpClient *tcp_client
) {
...
static void appln_client_disconnected(const TcpServerController*, const TcpClient *) {
